(() => {
  const translations = {
    en: {
      ...
      featured: 'FEATURED INSIGHT', date: '31 JULY 2026', readTime: '6 MIN READ',
      ...
      featured: 'NOSTETTU NÄKEMYS', date: '31. HEINÄKUUTA 2026', readTime: '6 MIN LUKUAIKA',
    ...
    sv: {
      ...
      featured: 'UTVALD INSIKT', date: '31 JULI 2026', readTime: '6 MIN LÄSNING',
    ...
    id: {
      ...
      featured: 'WAWASAN UTAMA', date: '31 JULI 2026', readTime: '6 MENIT BACA',
  ...
  const logoUrl = new URL('assets/balai-logo.svg', siteRoot).href;
